...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/int_m1_bot?start=r${id}\n\INT tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! INT Power Tap! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine INT tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/int_m1_bot?start=r${id}\n\ `, // Replace with your link
      text: "INT tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! Inta Power Tap! 🚀",
    };
  ...
  const fallbackShare = (shareData) => {
    const encodedText = encodeURIComponent(
      // eslint-disable-next-line
      `${shareData.url} \n\INT tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! Inta Power Tap! 🚀`
    );
            ...
            <div className="w-full flex items-center justify-between space-x-3 pb-3">
              ...
              <div className="w-[48.5%] flex flex-col text-[#000] font-medium text-[14px] bg-cards h-[85px] rounded-[10px] px-4 py-2 justify-start text-left relative">
                <h2 className="!m-0 font-semibold text-[#fff]">
                  ...
                  <span className="text-[18px]"> INT</span>
                </h2>
