              ...
              >
                <div className="w-full flex flex-col scroller h-[80vh] overflow-y-auto pb-[150px]">
                  <div className="w-full flex items-center justify-center space-x-5 py-6">
                    <div className="bg-cards3 text-[#dddddd] py-[15px] px-5 w-[45%] flex justify-center space-x-1 items-center rounded-[6px] text-[15px] font-medium">
                      {isTimerVisible ? (
                        <>
                          ...
                          <span className="text-nowrap">{`${formatTimeRemaining(
                            timeRemaining
                          )}`}</span>
                        </>
                      ) : (
                        <>
                          <span className="text-[16px]">
                            <PiHandTap
                              size={18}
                              className="tesxt-[#bcbcbc] text-btn4"
                            />
                          </span>
                    ...
                    <NavLink
                      to="/boost"
                      className="bg-cards3 py-[15px] px-5 text-[#dddddd] font-medium w-[45%] flex justify-center space-x-1 items-center rounded-[6px] text-[15px]"
                    >
                      <span className="text-[16px]">
                        <img
                          src="/boost.webp"
                          alt="dfd"
                          className="text-btn4 w-[20px]"
                        />
                      </span>
                      <span className="text-nowrap">Boosters</span>
                      <span className="flex items-center">
                        <PiArrowRightBold
                          size={16}
                  ...
                  <h1 className="flex w-full justify-center items-center space-x-1 pb-2">
                    ...
                    <span className="text-[#fff] text-[32px] font-bold">
                      <span className="pl-[2px]">
                        ...
                        <span className="text-btn4">INT</span>
                      </span>
                    </span>
                  </h1>
                  <div></div>
                      ...
                      {energy === 0 && points === 0 ? (
                        ...
                        <>
                          <span className="text-[#fff] font-semibold text-[24px]">
                            <span className="pl-[2px]">
                              {points} <span className="text-btn4">INT</span>
                            </span>
                          </span>
                          <button
                            onClick={handleClaim}
                ...
                >
                  <div className="w-full flex justify-center flex-col items-center space-y-3">
                    ...
                    <p className="pb-6 text-[#bfbfbf] text-[15px] w-full text-center">
                      Keep grinding! something huge is coming! Get more INT ow!
                    </p>
                              ...
                              >
                                ...
                                >
                                  <img
                                    ...
                                    alt={character.name}
                                    className="w-[70px] h-[90px] object-cover absolute bottom-0 object-top"
                                  />
                                </div>
